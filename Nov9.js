...
const wLine = window.innerWidth/1.3;//(window.innerWidth)/2;
const hLine = 420;//(window.innerHeight/1.2);
const marginLine = {top: 6, right: 45, bottom: 40, left: 90};
let data;
...
/////////////////////////////
        ...
        // Add X axis
        g.append("g")
            .attr("class", "axis axisX") // mind class of "axis"
